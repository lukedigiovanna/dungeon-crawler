...
void AnimationManager::registerAnimation(std::string id, std::shared_ptr<AnimationSpriteDeck> spriteDeck) {
...
std::shared_ptr<AnimationSpriteDeck> AnimationManager::getAnimation(std::string id) const {
